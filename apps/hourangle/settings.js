(function(back) {
  ...
  function createYearMenu(settingName) {
  ...
  var mainmenu = {
    ...
    "Longitude °" : {
      value: getLonDegrees(), min:0, max:180, step:1,
      format: v=>v+"°", onchange: v=>updateLonFromUI(v,getLonDir())
    },
    ...
    "Display Style": {
      value: settings.displayStyle, min:1, max:3, step:1,
      format:v=>"Style "+v,
    ...
    "Valid From": createYearMenu("validityYearFrom"),
    "Valid To":   createYearMenu("validityYearTo")
  };
